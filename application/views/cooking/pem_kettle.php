...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cooking /</span>Pemeriksaan Pemasakan Produk Di
            Steam /Cooking Kettle</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pem_kettle/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('kettleTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="kettleTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            foreach ($pem_kettle as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $val->waktu_start_stop; ?></td>
                                    <td><?= $val->mesin; ?></td>

                                    <td>
                                        <a href="<?= base_url('pem_kettle/edit/' . $val->uuid); ?>" class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_kettle/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_kettle/hapus/' . $val->uuid); ?>" class="btn btn-danger"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_kettle/print_multiple_excel"); ?>';
