    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pem_thawing/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('thawingTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pemeriksaan Pemasakan Dengan thawing</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="thawingTable">
                        <thead>
                            <tr>
                                ...
                                <th>Suhu Ruangan</th>
                                <th>Mulai Thawing Pukul</th>
                                <th>Selesai Thawing Pukul</th>
                        ...
                        <tbody>
                            ...
                            foreach ($pem_thawing as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $val->kondisi_ruangan; ?></td>
                                    <td><?= $val->jenis_produk; ?></td>
                                    <td><?= $val->jumlah; ?></td>
                                    <td><?= $val->kode_produksi; ?></td>

                                    <td><?= $val->suhu_ruangan; ?></td>
                                    <td><?= $val->mulai_thawing_pukul; ?></td>
                                    <td><?= $val->selesai_thawing_pukul; ?></td>

                                    <td><?= $val->suhu_produk; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td class="text-center">
                                        <a href="<?= base_url('pem_thawing/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_thawing/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_thawing/hapus/' . $val->uuid); ?>" class="btn btn-danger"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_thawing/print_multiple_excel"); ?>';
