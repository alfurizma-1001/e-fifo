            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('steamerTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="steamerTable">
                        <thead>
                            <tr>
                            ...
                            foreach ($pem_masak_steamer as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('pem_masak_steamer/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_masak_steamer/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_masak_steamer/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_masak_steamer/print_multiple_excel"); ?>';
