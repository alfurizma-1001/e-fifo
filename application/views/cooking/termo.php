            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('termoTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="termoTable">
                        <thead>
                            <tr>
                            ...
                            foreach ($termo as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?= base_url('termo/print_excel/' . $val->uuid); ?>" class="btn btn-info"
                                            target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('termo/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("termo/print_multiple_excel"); ?>';
