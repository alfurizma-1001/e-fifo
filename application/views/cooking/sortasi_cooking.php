...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form Cooking /</span> SortasiBahan Baku TDK
            Sesuai</h4>
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('sortasicookingTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="sortasicookingTable">
                        <thead>
                            <tr>
                            ...
                            foreach ($sortasi_cooking as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('sortasi_cooking/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('sortasi_cooking/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('sortasi_cooking/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("sortasi_cooking/print_multiple_excel"); ?>';
