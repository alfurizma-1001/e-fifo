                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="kode_produksi" class="form-control" id="kode_produksi" name="kode_produksi"
                                    value="<?= $pem_kettle->kode_produksi ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="waktu_start_stop" class="form-control" id="waktu_start_stop"
                                    name="waktu_start_stop" value="<?= $pem_kettle->waktu_start_stop ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="mesin" class="form-label">Mesin</label>
                                <input type="mesin" class="form-control" id="mesin" name="mesin"
                                    value="<?= $pem_kettle->mesin ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="waktu" class="form-label">Waktu</label>
                                <input type="text" class="form-control" id="waktu" name="waktu"
                                    value="<?= $pem_kettle->waktu ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="tahapan_proses" class="form-label">Tahapan Proses</label>
                                <select class="form-control" id="tahapan_proses" name="tahapan_proses" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="formulasike" name="formulasike" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jenis_bahan" name="jenis_bahan"
                                    value="<?= $pem_kettle->jenis_bahan ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jumlah_standar" name="jumlah_standar"
                                    value="<?= $pem_kettle->jumlah_standar ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="lama_proses" name="lama_proses"
                                    value="<?= $pem_kettle->lama_proses ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="mixing_paddle_on" name="mixing_paddle_on"
                                    value="<?= $pem_kettle->mixing_paddle_on ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="target_temperature"
                                    name="target_temperature" value="<?= $pem_kettle->target_temperature ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="actual_temperature"
                                    name="actual_temperature" value="<?= $pem_kettle->actual_temperature ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="suhu_pusat_produk" name="suhu_pusat_produk"
                                    value="<?= $pem_kettle->suhu_pusat_produk ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="organoleptik_warna"
                                    name="organoleptik_warna" value="<?= $pem_kettle->organoleptik_warna ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="organoleptik_aroma"
                                    name="organoleptik_aroma" value="<?= $pem_kettle->organoleptik_aroma ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="organoleptik_rasa" name="organoleptik_rasa"
                                    value="<?= $pem_kettle->organoleptik_rasa ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="catatan_kanan" name="catatan_kanan"
                                    value="<?= $pem_kettle->catatan_kanan ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="catatan" class="form-label">Catatan</label>
                                <input type="text" class="form-control" id="catatan" name="catatan"
                                    value="<?= $pem_kettle->catatan ?>" required>
                            </div>
